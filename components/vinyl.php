<div class="bg-black">
    ...
    <div class="text-center py-16">
        ...
        <div class="flex lg:justify-center vinyls mx-auto px-7 w-1/2 h-auto lg:w-auto">
            ...
            <img src="<?php the_sub_field('vinyl_plate');?>" alt="" class="plate ml-[-90px] lg:ml-[-250px]
            ease-in duration-300 object-contain w-3/4 h-auto lg:w-auto">
        </div>
        <div  class="py-24 font-semibold">
            <span style="background-color: <?php the_sub_field('button_color');?>" class="uppercase py-4 lg:py-7 px-36
            md:text-[16px] text-xs border-black border-2 rounded-full tracking-wider">
