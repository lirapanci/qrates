...
<body <?php body_class();?>>
<header class=" py-5 lg:flex items-center font-eina-light text-[16px] w-full relative tracking-wide">
    ...
    <div class="font-roboto font-bold tracking-wider lg:px-24 lg:pt-0 lg:bg-none w-full lg:w-auto text-left my-5 lg:my-0 absolute lg:relative z-10 bg-white flex items-center">
