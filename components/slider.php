<div class="swiper mySwiper lg:border-black lg:border-2 ">
    ...
    <div class="swiper-wrapper ">
        ...
        <div style="background-color: <?php the_sub_field('background_color');?>" class="swiper-slide flex flex-wrap
        lg:flex-nowrap">
            ...
            <div  class="w-full  order-1 lg:order-2 p-4 lg:p-0">
                <img src="<?php the_sub_field('artist_image');?>" alt="" class="h-full border-2 border-black
                lg:border-l-2 lg:border-r-none lg:border-y-0">
            </div>
      </div>
        <?php
        endwhile;
